  ...
  return (
    <div className="container mx-auto">
      <div className=" bg-gray-800 p-10 ">
        <div
        onClick={onClick}
        className="md:ml-10 flex items-center justify-center shadow-lg shadow-indigo-500/50 border hover:border-doted border-fuchsia-50 bg-purple-400 rounded-lg p-4  card "
      >
          <img
